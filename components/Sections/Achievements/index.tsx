...
import { GiTrophy, GiMedal, GiBasketballJersey, GiTargeted, GiFootprint, GiStairs, GiTeamUpgrade } from 'react-icons/gi'
...
const Achievements = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: 'Received team\'s Leadership Award',
      icon: GiStairs,
      year: '2024',
    },
  ]
